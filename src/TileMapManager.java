...
*/
    ...
    public TileMap loadMap(String filename) throws IOException {
        ...
        int mapWidth = 0;
        int mapHeight = 0;
        filename = "assets" + File.separator + "maps" + File.separator + filename;
...
*/
    ...
    public void loadTileImages() {
        ...
        char ch = 'A';
        while (true) {
            String filename = "assets" + File.separator + "images" + File.separator + "tiles" + File.separator + "tile_" + ch + ".png";
            file = new File(filename);
            if (!file.exists()) { break; } 
            else System.out.println("Tile image loaded: " + filename);
