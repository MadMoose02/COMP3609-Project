...
public class Animation {
    ...
    private long totalDuration;			    // total duration of the animation in milliseconds
    private boolean loop;                   // if the animation should loop
    private boolean isActive;               // if the animation is active
