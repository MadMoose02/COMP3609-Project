...
public class Player {			
    ...
    public Player (JPanel panel, TileMap t, BackgroundManager b) {
        ...
        playerLeftImage = ImageManager.loadImage("player-left.gif");
        playerRightImage = ImageManager.loadImage("player-right.gif");
    ...
    public Point collidesWithTileDown (int newX, int newY) {
        ...
        int offsetY = TileMap.pixelsToTiles(tileMap.getOffsetY());
        int xTile = TileMap.pixelsToTiles(newX);
